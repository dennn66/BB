...
enum MouseType_t
{
	PS2_MOUSE_NONE = 0, // No PS2 mouse present
	PS2_MOUSE_STANDARD = 1, // Standard PS2 mouse
	PS2_MOUSE_MIE = 3, // Microsoft Intellimouse Extensions (MIE)
	PS2_MOUSE_GENIUS5 = 5, //genius "netscroll optical" (5 buttons)
};
